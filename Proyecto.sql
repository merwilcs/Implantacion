...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 10-11-2022 a las 04:42:57
...
--
-- Estructura de tabla para la tabla `hitorial`
--
...
ALTER TABLE `empresa`
  ...
  ADD KEY `estado_id_estado_empresa` (`ID_Estado`),
  ADD KEY `ciudades_id_ciudades_empresa` (`ID_Ciudades`),
  ADD KEY `municipio_id_municipios_empresa` (`ID_Municipios`),
  ADD KEY `parroquia_id_parroquia_empresa` (`ID_parroquias`);
...
--
-- Indices de la tabla `hitorial`
--
ALTER TABLE `hitorial`
  ADD PRIMARY KEY (`Id_historial`),
  ADD KEY `pedido_Cant_pedido_hitorial` (`Cant_pedido`);
...
ALTER TABLE `pedido`
  ...
  ADD KEY `user_id_usuario_pedido` (`ID_Usuario`),
  ADD KEY `producto_ID_producto_pedido` (`ID_producto`),
  ADD KEY `tipo_pago_id_tipopago_pedido` (`ID_tipopago`);
...
ALTER TABLE `proveedor`
  ...
  ADD KEY `producto_id_producto_proveedor` (`ID_Producto`),
  ADD KEY `estados_id_estados_proveedor` (`id_estado`),
  ADD KEY `ciudades_id_ciudades_proveedor` (`id_ciudad`),
  ADD KEY `municipios_id_municipios_proveedor` (`id_municipio`),
  ADD KEY `parroquia_id_parroquia_proveedor` (`id_parroquia`);
...
ALTER TABLE `user`
  ...
  ADD KEY `status_id_status_user` (`ID_status`),
  ADD KEY `estados_id_estados_user` (`ID_Estado`),
  ADD KEY `ciudades_id_ciudades_user` (`ID_Ciudades`),
  ADD KEY `municipios_id_municipios_user` (`ID_Municipios`),
  ADD KEY `parroquia_id_parroquia_user` (`ID_parroquias`);
...
--
ALTER TABLE `bancos`
  MODIFY `ID_Bancos` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `hitorial`
--
ALTER TABLE `hitorial`
...
--
ALTER TABLE `empresa`
  ADD CONSTRAINT `ciudades_id_ciudades_empresa` FOREIGN KEY (`ID_Ciudades`) REFERENCES `ciudades` (`id_ciudad`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `estado_id_estado_empresa` FOREIGN KEY (`ID_Estado`) REFERENCES `estados` (`id_estado`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `municipio_id_municipios_empresa` FOREIGN KEY (`ID_Municipios`) REFERENCES `municipios` (`id_municipio`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `parroquia_id_parroquia_empresa` FOREIGN KEY (`ID_parroquias`) REFERENCES `parroquias` (`id_parroquia`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `hitorial`
--
ALTER TABLE `hitorial`
  ADD CONSTRAINT `pedido_Cant_pedido_hitorial` FOREIGN KEY (`Cant_pedido`) REFERENCES `pedido` (`ID_pedido`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `pedido`
  ADD CONSTRAINT `producto_ID_producto_pedido` FOREIGN KEY (`ID_producto`) REFERENCES `producto` (`ID_producto`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `tipo_pago_id_tipopago_pedido` FOREIGN KEY (`ID_tipopago`) REFERENCES `tipo_pago` (`ID_tipopago`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `user_id_usuario_pedido` FOREIGN KEY (`ID_Usuario`) REFERENCES `user` (`ID_Usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `proveedor`
--
ALTER TABLE `proveedor`
  ADD CONSTRAINT `ciudades_id_ciudades_proveedor` FOREIGN KEY (`id_ciudad`) REFERENCES `ciudades` (`id_ciudad`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `estados_id_estados_proveedor` FOREIGN KEY (`id_estado`) REFERENCES `estados` (`id_estado`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `municipios_id_municipios_proveedor` FOREIGN KEY (`id_municipio`) REFERENCES `municipios` (`id_municipio`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `parroquia_id_parroquia_proveedor` FOREIGN KEY (`id_parroquia`) REFERENCES `parroquias` (`id_parroquia`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `producto_id_producto_proveedor` FOREIGN KEY (`ID_Producto`) REFERENCES `producto` (`ID_producto`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Filtros para la tabla `user`
--
ALTER TABLE `user`
  ADD CONSTRAINT `ciudades_id_ciudades_user` FOREIGN KEY (`ID_Ciudades`) REFERENCES `ciudades` (`id_ciudad`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `estados_id_estados_user` FOREIGN KEY (`ID_Estado`) REFERENCES `estados` (`id_estado`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `municipios_id_municipios_user` FOREIGN KEY (`ID_Municipios`) REFERENCES `municipios` (`id_municipio`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `parroquia_id_parroquia_user` FOREIGN KEY (`ID_parroquias`) REFERENCES `parroquias` (`id_parroquia`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `status_id_status_user` FOREIGN KEY (`ID_status`) REFERENCES `status` (`ID_status`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
